...
const AccidentLaw = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Hero Section */}
      <section className="bg-gradient-to-br from-orange-900 via-orange-800 to-orange-900 text-white py-20">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-orange-100 mb-8 leading-relaxed">
                Más de 1,200 casos de accidentes resueltos con éxito. 
                Luchamos por obtener la máxima compensación que le corresponde. 
              ...
              <div className="bg-orange-800 bg-opacity-50 rounded-lg p-6 mb-8">
                <div className="flex items-center space-x-3 mb-3">
                  ...
                  <span className="font-semibold">Atención 24/7 para Emergencias</span>
                </div>
                <p className="text-orange-100 text-sm">
                  Los primeros momentos tras un accidente son cruciales. 
                  Nuestro equipo está disponible las 24 horas para asesorarle inmediatamente.
                </p>
              </div>
            ...
            <div>
              <img 
                src="https://images.pexels.com/photos/5668391/pexels-photo-5668391.jpeg?auto=compress&cs=tinysrgb&w=800"
                alt="Abogado especialista en accidentes"
